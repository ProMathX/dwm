...
//static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb",normbgcolor, "-nf",selfgcolor, "-sb", selbgcolor, "-sf", selbordercolor, NULL };
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", selfgcolor, "-sb", selbgcolor, "-sf", selbordercolor, "-c", "-l", "30", NULL };
