...
// rstolen
static unsigned int gappih = 40; /* horiz inner gap between windows */
static unsigned int gappiv = 40; /* vert inner gap between windows */
static unsigned int gappoh = 60; /* horiz outer gap between windows and screen edge */
static unsigned int gappov = 60; /* vert outer gap between windows and screen edge */
//
...
static const char *fonts[] = {"terminus:size=18", "NotoColorEmoji:pixelsize=18;antialias=true;autohint=true"};
static const char dmenufont[] = "terminus:size=18";
...
// static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb",normbgcolor, "-nf",selfgcolor,
// "-sb", selbgcolor, "-sf", selbordercolor, NULL };
static const char *dmenucmd[] = {"dmenu_run",    "-m",  dmenumon,   "-fn", dmenufont,  "-nb",
                                 normbgcolor,    "-nf", selfgcolor, "-sb", selbgcolor, "-sf",
                                 selbordercolor, "-c",  "-l",       "30",  NULL};
...
static const Key keys[] = {
    ...
    {MODKEY | ControlMask, XK_m, spawn, {.v = (const char *[]){MAIL, NULL}}},
    ...
    {MODKEY | ShiftMask, XK_m, spawn, SHCMD("dmenu_musicpicker")},
    {MODKEY | ShiftMask, XK_l, spawn, SHCMD("slock")},
    {MODKEY | ShiftMask, XK_s, spawn, SHCMD("screenshot")},
    {MODKEY | ShiftMask, XK_BackSpace, spawn, SHCMD("sysstate")},
    {MODKEY | ShiftMask, XK_t, spawn, SHCMD(TERMINAL "-e tasks")},
    ...
    {MODKEY | ShiftMask, XK_a, setgaps, {.i = 10}},
